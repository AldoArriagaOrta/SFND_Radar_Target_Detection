...
for i=1:length(t)         
    ...
    % The time delay is the time needed to reach the current position of
    % the target and come back to the receiver.
    td(i) = 2 * r_t(i) / c; 
...
% 
% Setting these values to zero has to be done AFTER calculating CFAR.
% Otherwise it would alter the results of averaging the training cells.
